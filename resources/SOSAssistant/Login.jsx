...
const Login = () => {
  ...
  const componentToLoad = useSelector(state => state.activity.componentToLoad);
  ...
  const getUser = (sessionToken) => {
    ...
    let response = "";
    let data = "";
    let operation = "Get SOS Assistant User";
  ...
  const postLogin = (usernameEntered, passwordEntered) => {
    ...
    let response = "";
    let data = "";
    let operation = "SOS Assistant Login";
  ...
  const updateLoginStatus = (user, usernameEntered, passwordEntered) => {
    ...
    if (newStatus === "success") {
      ...
      dispatch(setComponentToLoad("SelectSession"));
  ...
  return (
    <>
      ...
      {isEmpty(loggedInUser) && (isEmpty(componentToLoad) || componentToLoad === "Login") ?
